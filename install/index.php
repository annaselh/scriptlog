          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed" >
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed" >
              <div>
                 ...
                 ?>
                  <small class="<?=(isset($plugin_passed)) ? $plugin_passed : 'text-danger'; ?>"><?=(isset($plugin_passed)) ? 'library/plugins writeable' : $errors['errorChecking'] = 'library/plugins is not writeable'; ?></small>
              </div>
    ...
    <p class="mb-1">&copy; 
       <?php 
        ...
        <ul class="list-inline">
          ...
          <li class="list-inline-item"><a href="#"><?= 'Execution time: <strong>'.$time = ($execution_started - $_SERVER["REQUEST_TIME_FLOAT"]). ' seconds</strong>'; ?></a></li>
        </ul>
      </footer>
    </div>
